...
public class Bounce : MonoBehaviour
{
    ...
    private float _PortalTimer = 0.0f;
    private float PORTAL_TIMER_SETTER = 4.0f;
    public float PORTAL_TIMER_INITILIZER = 8.0f;
    ...
    void Start()
    {
        ...
        _PortalTimer = PORTAL_TIMER_INITILIZER;
    }
    ...
    void Update()
    {
        ...
        if(_PortalTimer < 0){
            ...
            _PortalTimer = PORTAL_TIMER_SETTER;
            _velocity = dir.normalized * SPEED;
        }
    }
}
